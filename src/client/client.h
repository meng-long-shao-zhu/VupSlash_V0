...
public:
    ...
    void refreshOvertPile(const QVariant &player_arg);
    ...
    void setPublicCards(const QVariant &set_str);
...
signals:
    ...
    void gongxin(const QList<int> &card_ids, bool enable_heart, QList<int> enabled_ids, const QString &player_name);
