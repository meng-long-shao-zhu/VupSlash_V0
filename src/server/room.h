...
public:
    ...
    void acquireTurnEndSkills(ServerPlayer *player,const QString &skill_name, const QStringList &skill_names);
    void acquireTurnEndSkills(ServerPlayer *player, const QString &skill_name, const QString &skill_names);
    ...
    void fillAG(const QList<int> &card_ids, ServerPlayer *who = NULL, const QList<int> &disabled_ids = QList<int>(), bool hide_suit_number = false, const QString &foot_notes = "", bool refresh_handcard_visible = false);
    ...
    int getLevelSkillState(ServerPlayer *player, const QString &skill_name);
    void setLevelSkillState(ServerPlayer *player, const QString &skill_name, int n);
