...
public:
    ...
    void fillAG(const QList<int> &card_ids, ServerPlayer *who = NULL, const QList<int> &disabled_ids = QList<int>(), bool hide_suit_number = false, const QString &foot_notes = "");
