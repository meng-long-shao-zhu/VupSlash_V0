...
public:
    ...
    static Relation GetRelation2v2(const ServerPlayer *a, const ServerPlayer *b);
    ...
    virtual void askForGuanxing(const QList<int> &cards, QList<int> &up, QList<int> &bottom, int guanxing_type, int up_limit, int down_limit) = 0;
...
public:
    ...
    virtual void askForGuanxing(const QList<int> &cards, QList<int> &up, QList<int> &bottom, int guanxing_type, int up_limit, int down_limit);
