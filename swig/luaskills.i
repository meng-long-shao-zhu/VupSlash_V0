...
void LuaOffensiveHorse::pushSelf(lua_State *L) const
{
    LuaOffensiveHorse *self = const_cast<LuaOffensiveHorse *>(this);
    SWIG_NewPointerObj(L, self, SWIGTYPE_p_LuaOffensiveHorse, 0);
}
...
void LuaDefensiveHorse::pushSelf(lua_State *L) const
{
    LuaDefensiveHorse *self = const_cast<LuaDefensiveHorse *>(this);
    SWIG_NewPointerObj(L, self, SWIGTYPE_p_LuaDefensiveHorse, 0);
}
