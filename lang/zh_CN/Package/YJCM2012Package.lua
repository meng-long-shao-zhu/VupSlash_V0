...
return {
	...
	["new_madai"] = "新马岱",
	["newqianxi"] = "潜袭",
	[":newqianxi"] = "准备阶段开始时，你可以摸一张牌然后弃置一张牌，若如此做，你令一名距离为1的角色不能使用或打出与你以此法弃置的牌颜色相同的手牌，直到回合结束。 ",
	["newqianxi-discard"] = "请弃置一张牌",
	...
	["&new_liubiao"] = "刘表",
	["newzishou"] = "自守",
	[":newzishou"] = "摸牌阶段，你可以多摸X张牌（X为全场势力数），然后本回合内，当你对其他角色造成伤害时，防止此伤害。",
	["newzishou:newzishou"] = "你是否发动“自守”多摸%src张牌？",
	["#NewzishouPrevent"] = "%from 的“%arg”被触发，防止了对 %to 的 %arg2 点伤害",
